            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
                ...
                <Card className="border-border/50 shadow-lg flex flex-col">
                    <CardHeader>
                        ...
                        <CardTitle className="text-2xl font-bold">เข้าร่วมครอบครัว</CardTitle>
                        <CardDescription>
                    ...
                    <CardContent className="flex-1 flex flex-col justify-end space-y-4">
                        ...
                        <Button
                            className="w-full bg-rose-600 hover:bg-rose-700 text-white h-12 text-base"
                ...
                <Card className="border-border/50 shadow-lg flex flex-col">
                    <CardHeader>
                        ...
                        <CardTitle className="text-2xl font-bold">สร้างครอบครัว</CardTitle>
                        <CardDescription>
                            สร้างครอบครัวของคุณเอง รับสมัครสมาชิก และสร้างความอบอุ่น
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="flex-1 flex flex-col justify-end space-y-4">
                        <div className="space-y-2">
                        ...
                        >
                            {isActionLoading ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : <Plus className="mr-2 h-5 w-5" />}
                            สร้างครอบครัว
                        </Button>
                    </CardContent>
                </Card>
