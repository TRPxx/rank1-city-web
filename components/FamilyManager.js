...
import { LogOut, Settings, Search, Filter, Trophy, Loader2, Shield, Hexagon, ChevronDown, Copy, Users, Star } from 'lucide-react';
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div className="space-y-6">
                        <div className="relative">
                            ...
                            <div className="relative bg-zinc-900 border border-zinc-800 p-8 rounded-2xl">
                                <h1 className="text-4xl font-bold text-white mb-2">Start Your Family</h1>
                                <p className="text-zinc-400 mb-8">Create a close-knit family, support each other, and build your legacy together.</p>

                                <form onSubmit={handleCreateFamily} className="space-y-4">
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium text-zinc-300">Family Name</label>
                                        <Input
                                            placeholder="e.g. Toretto Family"
                                            value={createName}
                                            onChange={(e) => setCreateName(e.target.value)}
                                            className="bg-black/50 border-zinc-700 focus:border-rose-500"
                                            required
                                        />
                                    </div>
                                    <div className="space-y-2">
                                    ...
                                    <Button
                                        ...
                                        disabled={isCreating}
                                    >
                                        {isCreating ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : <Heart className="w-4 h-4 mr-2" />}
                                        Create Family
                                    </Button>
                                </form>
                            </div>
                    ...
                    <div className="space-y-6">
                        <div className="relative">
                            ...
                            <div className="relative bg-zinc-900 border border-zinc-800 p-8 rounded-2xl">
                                <h2 className="text-2xl font-bold text-white mb-2">Join a Family</h2>
                                <p className="text-zinc-400 mb-8">Received an invite? Enter the code to join a family.</p>
                        ...
                        <div className="relative mb-6 inline-block group/avatar">
                            <div className={`w-28 h-28 rounded-2xl p-1 bg-gradient-to-br ${theme.from} ${theme.to}`}>
                                <Avatar className="w-full h-full rounded-xl border-4 border-black/50">
                                    ...
                                    <AvatarFallback className="bg-zinc-900 text-rose-400 text-2xl font-bold">
                            ...
                            {isLeader && (
                                <Dialog>
                                    ...
                                    <DialogContent className="bg-zinc-900 border-zinc-800">
                                        ...
                                        <DialogFooter>
                                            <Button onClick={handleUpdateLogo} disabled={isEditingLogo} className="bg-rose-600 hover:bg-rose-700">
